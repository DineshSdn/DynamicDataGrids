CREATE PROCEDURE [app].[AddOrUpdateData]
(
    @id INT = NULL,
    @name NVARCHAR(100),
...
BEGIN
    ...
    BEGIN
        INSERT INTO YourTableNameHere (name, description, show_health_profile, type, active, code_key, created_datetime, created_by, modified_datetime, modified_by, MasterDgTypes)
